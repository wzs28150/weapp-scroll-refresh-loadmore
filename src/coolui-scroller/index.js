...
Component({
  ...
  properties: {
    ...
    batch: {
      ...
      value: false,
      public: true,
      observer: '_scrollerInnerBatchDataChanged'
    },
    batchKey: {
      type: String,
      value: 'batchSetScrollerData',
      public: true,
    },
    scrollTop: {
      type: Number,
  ...
  methods: {
    ...
    _clearList(cb) {
      ...
      this.page._scrollerViewportChange({
        detail: {
          data: pos,
          id: this.id
        }
    ...
    _scrollViewDidScroll(e, force) {
      ...
      this._calcViewportIndexes(scrollLeft, scrollTop,
        ...
        that.page._scrollerViewportChange({
          detail: {
            data: that._pos,
            id: that.id
          }
    ...
    _scrollerInnerBatchDataChanged(cb) {
